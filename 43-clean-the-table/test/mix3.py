...
class Pickandplaceobject(Node):
    def __init__(self):
        ...
        # initial pose to goal pose 1 23-60
...
#   end of initialization intial pose 
...
# gripper interface function
        ...
        try:
            ...
            if hasattr(result, 'navigation_status'): 
                if result.navigation_status == NavigateToPose.Result.SUCCEEDED:
                    ...
                    self.initialize_timer()  # Initialize the timer when the goal is reached
                else:
    ...
    def initialize_timer(self):
        """
        Initializes the timer to run the timer_callback infinitely.
        ...
        if not self.timer_initialized:
            ...
            self.timer_initialized = True  # Ensure the timer is created only once
