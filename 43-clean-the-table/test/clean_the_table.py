...
# add initialpose
    ...
    def publish_initial_pose(self):
        ...
        # Initial position
        initial.pose.pose.position.x = -7.6370036292276
        initial.pose.pose.position.y = 1.4047448021783846
        initial.pose.pose.position.z = 0.0 

        # Initial orientation (facing forward)

        initial.pose.pose.orientation.w = 0.99748447613780921
        initial.pose.pose.orientation.z = 0.07088525843982242
    ...
    def publish_goal(self):
        ...
        #goal.pose.position.x = -7.242931365966797
        #goal.pose.position.y = 1.3187459707260132
